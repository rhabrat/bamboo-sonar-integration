...
/**
 * {@link Predicate} implementation to check if a {@link TaskIdentifier} points to a Sonar Builder Task
 * 
 * @author <a href="mailto:markrekveld@marvelution.com">Mark Rekveld</a>
 */
public class IsSonarTaskPredicate implements Predicate<TaskIdentifier> {
